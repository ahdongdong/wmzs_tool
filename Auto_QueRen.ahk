...
TargetText_KSTZ .="|<>**50$96."
;挑战按钮
...
; 重选对手
Text_DFDJ_TZ.="|<>**50$90."
...
TrySearchAndClick(hwnd)
{
    ...
    if (cbKSTZ.Value)
    {
        ...
        {
            ; 巅峰对决已完成，点击空白关闭
            ToolTip "窗口 " hwnd " 巅峰对决已完成   (" X "," Y ")", 20, 20
            SetTimer(() => ToolTip(), -800)
            if(FindText(&X, &Y, x1, y1, x2, y2, 0.1, 0.5, Text_DFDJ_200_OK, 1, 0.80))
            {
        ...
        else if (ok := FindText(&X, &Y, x1, y1, x2, y2, 0.1, 0.5, TargetText_KSTZ, 1, 0.80))
        {
            ; 转为屏幕坐标并点击
